...
// imtiaz not working now for sais code strt
// import React, { useState, useEffect, useContext } from "react";
// import {
//     FaPlus,
//     FaTimes,
...
// // Main Task component for managing tasks
// const Task = ({ loggedInUserId }) => {
//     const { user } = useAuth();
//     const [showForm, setShowForm] = useState(false);
//     const [tasks, setTasks] = useState([]);
...
//     return (
//         <div className="max-w-3xl mx-auto p-6 bg-white shadow-xl rounded-lg my-20">
//             {(userRole === "admin" || userRole === "group leader") && (
//                 <div className="flex justify-between items-center mb-6">
//                     <h2 className="text-2xl font-bold text-gray-800">My Tasks</h2>
//                     <button
//                         onClick={toggleForm}
//                         className="bg-blue-500 text-white px-5 py-2 rounded-lg flex items-center shadow-lg hover:bg-blue-600"
//                     >
//                         <FaPlus className="mr-2" /> Add Task
//                     </button>
//                 </div>
...
//                     likeCount: prev.likeCount + (activeReaction === "like" ? -1 : 1),
//                     disLikeCount:
//                         activeReaction === "dislike" ? prev.disLikeCount - 1 : prev.disLikeCount,
//                 };
//             } else {
//                 return {
//                     ...prev,
//                     disLikeCount: prev.disLikeCount + (activeReaction === "dislike" ? -1 : 1),
//                     likeCount: activeReaction === "like" ? prev.likeCount - 1 : prev.likeCount,
//                 };
//             }
//         });
//         setActiveReaction((prev) => (prev === reactType ? null : reactType));
...
//                 </a>
//             )}
//             <div>Done Count: {task.doneCount || 0}</div>
//             <div>In Progress Count: {task.inProgressCount || 0}</div>
//             {task.userId === loggedInUserId && (
//                 <div className="mt-4 flex space-x-3">
//                     <button
//                         onClick={() => onEdit(task)}
...
//                         onClick={handleAssignTask}
//                         disabled={assigned}
//                         className={`bg-green-500 text-white px-4 py-2 rounded shadow-md ${assigned ? "opacity-50 cursor-not-allowed" : "hover:bg-green-600"
//                             } transition`}
//                     >
//                         {assigned ? "Assigned" : "Assign Me"}
//                     </button>
...
//                             </h3>
//                             <CommentForm taskId={task._id} setComment={setComment} />
//                             <div className="mt-4">
